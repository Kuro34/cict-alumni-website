...
<body>
    <div class="form-container">
        <h2><i class="fa-solid fa-user-graduate me-2"></i>Admin Login</h2>
        ...
        <form action="{{ route('admin.login.submit') }}" method="POST">
            ...
            <!-- Optional: Forgot password for admin (keeps parity with alumni page) -->
            <div class="forgot-password-link mt-1 mb-2">
                @if(Route::has('admin.forgot-password.form'))
            ...
            <!-- Optional link area (left blank intentionally for admin) -->
            <div class="text-center mt-3 link">
                {{-- Example: <a href="{{ route('admin.register') }}">Need an admin account?</a> --}}
            </div>
        </form>
    </div>
